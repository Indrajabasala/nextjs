...
<section className="login-gradient-bg">
	<div className="login-details-white-card">
		<div className="login-white-card-left-details">
			...
			<div className="patientregistrationtext login-text">
				<h2>Provider / Clincian Registration form</h2>
			</div>
			<div className="patientregistrationform login-form">
				<form>
					<div className="row">
						<div className="col-md-6 col-xl-6 col-lg-6 col-sm-6  col-xs-12">
				<div className="custom-form-group form-group  ">
					<input className="input-field" type="text" placeholder="First Name" name="fname"/>

				  </div>
				</div>
				<div className="col-md-6 col-xl-6 col-lg-6 col-sm-6  col-xs-12">
				  <div className="custom-form-group form-group">
					<input className="input-field" type="password" placeholder="Last Name" name="lname"/>
			...
			<div className="col-md-6 col-xl-6 col-lg-6 col-sm-6  col-xs-12">
			  <div className="custom-form-group form-group">
				<input className="input-field" type="number" placeholder="Phone Number" name="phone"/>
			...
			<div className="row">
				<div className="col-md-6 col-xl-6 col-lg-6 col-sm-6  col-xs-12">
		<div className="custom-form-group form-group  ">
			<input className="input-field" type="number" placeholder="Zip Code (US)" name="zipcode"/>
		...
		<div className="col-md-6 col-xl-6 col-lg-6 col-sm-6  col-xs-12">
		  <div className="custom-form-group form-group">
			<select className="input-field">
				...
				<label><img src="images/patientregistration/selectarrow.png"/></label>
	...
	<div className="col-md-6 col-xl-6 col-lg-6 col-sm-6  col-xs-12">
	  <div className="custom-form-group form-group">
		<input className="input-field" type="number" placeholder="Unique Promo Code" name="promocode"/>
				...
				<div className="patient-text-btn login-text-btn register-text-btn">
					<a href="login.html" className="primary-button">
						...
						Go to Login </a>
					<a className="primary-button">Register Here <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path fill-rule="evenodd" clip-rule="evenodd" d="M9 5.25C9 5.05109 9.07902 4.86032 9.21967 4.71967C9.36032 4.57902 9.55109 4.5 9.75 4.5H21.75C21.9489 4.5 22.1397 4.57902 22.2803 4.71967C22.421 4.86032 22.5 5.05109 22.5 5.25V18.75C22.5 18.9489 22.421 19.1397 22.2803 19.2803C22.1397 19.421 21.9489 19.5 21.75 19.5H9.75C9.55109 19.5 9.36032 19.421 9.21967 19.2803C9.07902 19.1397 9 18.9489 9 18.75V15.75C9 15.5511 8.92098 15.3603 8.78033 15.2197C8.63968 15.079 8.44891 15 8.25 15C8.05109 15 7.86032 15.079 7.71967 15.2197C7.57902 15.3603 7.5 15.5511 7.5 15.75V18.75C7.5 19.3467 7.73705 19.919 8.15901 20.341C8.58097 20.7629 9.15326 21 9.75 21H21.75C22.3467 21 22.919 20.7629 23.341 20.341C23.7629 19.919 24 19.3467 24 18.75V5.25C24 4.65326 23.7629 4.08097 23.341 3.65901C22.919 3.23705 22.3467 3 21.75 3H9.75C9.15326 3 8.58097 3.23705 8.15901 3.65901C7.73705 4.08097 7.5 4.65326 7.5 5.25V8.25C7.5 8.44891 7.57902 8.63968 7.71967 8.78033C7.86032 8.92098 8.05109 9 8.25 9C8.44891 9 8.63968 8.92098 8.78033 8.78033C8.92098 8.63968 9 8.44891 9 8.25V5.25Z" fill="white"/>
						<path fill-rule="evenodd" clip-rule="evenodd" d="M17.781 12.531C17.8508 12.4613 17.9063 12.3786 17.9441 12.2875C17.9819 12.1963 18.0013 12.0987 18.0013 12C18.0013 11.9014 17.9819 11.8037 17.9441 11.7126C17.9063 11.6214 17.8508 11.5387 17.781 11.469L13.281 6.969C13.2113 6.89927 13.1285 6.84396 13.0374 6.80622C12.9463 6.76848 12.8486 6.74905 12.75 6.74905C12.6514 6.74905 12.5537 6.76848 12.4626 6.80622C12.3715 6.84396 12.2887 6.89927 12.219 6.969C12.1493 7.03873 12.094 7.12152 12.0562 7.21263C12.0185 7.30374 11.9991 7.40139 11.9991 7.5C11.9991 7.59862 12.0185 7.69627 12.0562 7.78738C12.094 7.87849 12.1493 7.96127 12.219 8.031L15.4395 11.25H2.25C2.05109 11.25 1.86032 11.329 1.71967 11.4697C1.57902 11.6103 1.5 11.8011 1.5 12C1.5 12.1989 1.57902 12.3897 1.71967 12.5303C1.86032 12.671 2.05109 12.75 2.25 12.75H15.4395L12.219 15.969C12.1493 16.0387 12.094 16.1215 12.0562 16.2126C12.0185 16.3037 11.9991 16.4014 11.9991 16.5C11.9991 16.5986 12.0185 16.6963 12.0562 16.7874C12.094 16.8785 12.1493 16.9613 12.219 17.031C12.2887 17.1007 12.3715 17.156 12.4626 17.1938C12.5537 17.2315 12.6514 17.2509 12.75 17.2509C12.8486 17.2509 12.9463 17.2315 13.0374 17.1938C13.1285 17.156 13.2113 17.1007 13.281 17.031L17.781 12.531Z" fill="white"/>
						</svg></a>
				</div>
			</div>
		</div>
